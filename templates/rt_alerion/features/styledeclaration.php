<?php
/**
* @version   $Id: styledeclaration.php 9989 2013-05-02 13:15:24Z kat $
...
class GantryFeatureStyleDeclaration extends GantryFeature {
	...
	if ($gantry->get('showcase-parallax') or $gantry->get('feature-parallax') or $gantry->get('utility-parallax') or
		...
		$gantry->addScript('rt-parallax.js');
	}

		// Demo Parallax Background
	if ($gantry->get('content-background')) $gantry->addLess('demo-parallax-bg.less');
